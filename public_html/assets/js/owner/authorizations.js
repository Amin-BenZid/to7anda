...
function annulation_demande(id) {
    // body...
    var res = id.split("/////");
    var id = res[0];
    var id_appa = res[1];
    ...
    $("#id_dem_aut_ann").val(id);
    $("#div_dem_aut_ann").hide();
...
function modification_demande(id) {
    ...
    var id = res[0];
    var id_appa = res[1];
    var date_debut = res[2];
    var heur_debut = res[3];
    var date_fin = res[4];
    var heur_fin = res[5];
    var nom = res[6];
    var prenom = res[7];
    var cin = res[8];
    var description = res[9];

    //id,id_appa,date_debut,heur_debut,date_fin,heur_fin,nom,prenom,cin,descption
...
$("#b_modif_action").click(function() {
   ...
   if(date_d =="" || date_f ==""  || temps_d ==""  || temps_f =="" || desc =="" || nom =="" || prenom =="" || cin ==""){
    ...
    $("#div_message_erreur_modif").show();
        ...
        $("#div_message_erreur_modif").show();
            ...
            var urla = localStorage.getItem("base_url")+'owner/authorizations/';
            ...
            var input_nom = $("<input>").attr("type", "text").attr("name", "nom").val(nom);
            $(form).append($(input_nom));
            var input_prenom = $("<input>").attr("type", "text").attr("name", "prenom").val(prenom);
            $(form).append($(input_prenom));
            var input_cin = $("<input>").attr("type", "text").attr("name", "cin").val(cin);
            $(form).append($(input_cin));
...
$("#b_demande_action").click(function() {
    ...
    $("#div_message_erreur_demande").show();
        ...
        $("#div_message_erreur_demande").show();
            ...
            $(form).append($(input_id_p));
            var input_nom = $("<input>").attr("type", "text").attr("name", "add_nom").val(nom);
            $(form).append($(input_nom));
            var input_prenom = $("<input>").attr("type", "text").attr("name", "add_prenom").val(prenom);
            $(form).append($(input_prenom));
            var input_cin = $("<input>").attr("type", "text").attr("name", "add_cin").val(cin);
            $(form).append($(input_cin));
